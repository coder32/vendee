                            ...
                            @foreach ( $Detail as $fb )
                                ...
                                <div class="col-md-12 profile_details" align="center">
                                    <div class="well profile_view">
                                        <div class="col-sm-12">
                                            <h4 class="brief"><i>ChildCategory Detail</i></h4>
                                            <div class="left col-xs-7">
                                                <h2><strong>ID # </strong>M - {{ $fb->id}}</h2>
                                                <ul class="list-unstyled" style="text-align:left">
                                                    <li ><i class="fa fa-circle-o-notch"></i><strong>   Category : {{ $Categ[0]->catName }}</strong></li>
                                                    <li ><i class="fa fa-circle-o-notch"></i><strong> Sub Category : {{ $SubCateg[0]->SubName }}</strong></li>
                                                    <li ><i class="fa fa-circle-o-notch"></i><strong>  Child Category : {{ $fb->name }}</strong></li>
                                        ...
                                        <div class="col-xs-12 bottom text-center">
                                            ...
                                            <div class="col-xs-12 col-sm-6 emphasis">
                                                <button type="submit" class="btn btn-success btn-xs">
                                                    <i class="fa fa-beer"></i> Child Category </button>
