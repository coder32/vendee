            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        {!! Form::open([
                                     'class'=>'post',
                                     'url'  => route(ADMIN . '.manager.insert'),
                                     'id'=> 'demo-form2',
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="email" name="email" pattern="^[A-Za-z0-9](([_\.\-]?[a-zA-Z0-9]+)*)@([A-Za-z0-9]+)(([\.\-]?[a-zA-Z0-9]+)*)\.([A-Za-z]{2,})$" placeholder="Enter Email" required class="form-control col-md-7 col-xs-12">
                            </div>
                        </div><br>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="number"  name="phone" placeholder="Enter Phone No."  maxlength="15"    oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" required class="form-control col-md-7 col-xs-12" >
                            </div>
                        </div><br>
