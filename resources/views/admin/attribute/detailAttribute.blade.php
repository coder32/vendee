                            ...
                            @foreach ( $Detail as $fb )
                                ...
                                <div class="col-md-12 profile_details" align="center">
                                    <div class="well profile_view">
                                        <div class="col-sm-12">
                                            <h4 class="brief"><i>Attribute Detail</i></h4>
                                            ...
                                            <div class="right col-xs-5 text-center">
                                                ...
                                                @else
                                                    <img src="../../../../storage/app/public/img/{{$fb->cover}}" class="img img-thumbnail img-responsive" style="height:300px">
                                                @endif
                                        ...
                                        <div class="col-xs-12 bottom text-center">
                                            ...
                                            <div class="col-xs-12 col-sm-6 emphasis">
                                                <button type="submit" class="btn btn-success btn-xs">
                                                    <i class="fa fa-beer"></i> Attribute </button>
