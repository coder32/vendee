    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Update<small>Attribute</small></h2>
                    ...
                    <div class="x_content">
                        <br />
                        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" name="form" enctype="multipart/form-data" action="{{ url('admin/attribute/updateAttribute') }}" >
                            {{csrf_field()}}
                        ...
                        <div class="form-group" name="txt_ctoken">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <textarea type="text" id="description" name="description"  required class="form-control col-md-7 col-xs-12">{{$update[0]->description}}</textarea>
                            </div>
                        </div><br>
