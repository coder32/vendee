                            ...
                            @foreach ( $Detail as $fb )
                                ...
                                <div class="col-md-12 profile_details" align="center">
                                    <div class="well profile_view">
                                        <div class="col-sm-12">
                                            <h4 class="brief"><i>SubCategory Detail</i></h4>
                                            <div class="left col-xs-7">
                                                <h2><strong>ID # </strong>M - {{ $fb->id}}</h2>
                                                <ul class="list-unstyled" style="text-align:left">
                                                    <li ><i class="fa fa-circle-o-notch"></i><strong>  Sub Category : {{ $fb->name }}</strong></li>
                                                    <li ><i class="fa fa-circle-o-notch"></i><strong> Category : {{ $fb->cat_id }}</strong></li>
