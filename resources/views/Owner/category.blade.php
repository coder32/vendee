        ...
        <div class="center_column col-xs-12 col-sm-10" id="center_column">
            <div class="profile-board">
                @include('admin.commun.flash-message')
                            ...
                            <h4>Category Detail <small>( {{ Auth::user()->name }} )</small></h4>
                <a href="{{ url('Owner/addCategory') }}" class="btn btn-success-outline" style="float: right">Add Category</a>
                ...
                <tr>
                   ...
                   {{-- <td>
                        <a href='{{ url("/Owner/destroyCatri/{$comments->id}") }}' class="btn btn-danger" onclick="return confirm('Are you sure you want to delete it?')">Delete</a>
                    </td>--}}
                </tr>
