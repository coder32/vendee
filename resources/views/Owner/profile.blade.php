            ...
            <div class="profile-board">
                <div class="profile-data">
                    <div class="col-sm-7 col-xs-12 ">
                        <div class="img"><img src="{{ URL::asset('../storage/app/public/img') }}/{{ auth()->user()->image }}"> </div>
                        <div class="details_list">
                            <h4>User Profile <a href="#.">Pro</a></h4>
                            <h6><a href="updateProfile" class="btn btn-danger;" style="float: right;">  Update Profile</a></h6>
                        </div>
                        <h6><a href="#."><i class="fa fa-cog"></i> {{ Auth::user()->name }}</a></h6>
                        <h6><a href="#."><i class="fa fa-cog"></i> {{ Auth::user()->email }}</a></h6>
                        <h6><a href="#."><i class="fa fa-cog"></i> {{ Auth::user()->phone }}</a></h6>
                        <h6><a href="#."><i class="fa fa-cog"></i> {{ Auth::user()->address }}</a></h6>
                    </div>
