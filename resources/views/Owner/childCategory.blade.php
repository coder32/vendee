        ...
        <div class="center_column col-xs-12 col-sm-10" id="center_column">
            <div class="profile-board">
                @include('admin.commun.flash-message')
                            ...
                            <h4>Child Category Detail <small>( {{ Auth::user()->name }} )</small></h4>
                <a href="{{ url('Owner/addChildCategory') }}" class="btn btn-success-outline" style="float: right">Add Child Category</a>
                ...
                <tr>
                    ...
                    <?php $i = 1; ?>
                    @foreach ($childcatri as $comments)
                <tr>
                    <td>{{$i}}</td>
                    <td>{{ $comments->name }}</td>
                    ...
                    <td>
                        <a href='{{ url("/Owner/destroyChildCatri/{$comments->id}") }}' class="btn btn-danger" onclick="return confirm('Are you sure you want to delete it?')">Delete</a>
                    </td>
                </tr>
