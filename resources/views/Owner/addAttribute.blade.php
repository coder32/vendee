    ...
    <div class="container-fluid" id="columns">
        ...
        <div class="center_column col-xs-12 col-sm-10" id="center_column">
            <div class="profile-board">
                ...
                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" name="form" enctype="multipart/form-data" action="{{ url('Owner/addAttribute') }}" >
                    {{csrf_field()}}
