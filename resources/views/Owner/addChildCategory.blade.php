    ...
    <div class="container-fluid" id="columns">
        ...
        <div class="center_column col-xs-12 col-sm-10" id="center_column">
            <div class="profile-board">
                ...
                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" name="form" enctype="multipart/form-data" action="{{ url('Owner/addChildCategory') }}" >
                    {{csrf_field()}}
                    ...
                    <div class="col-sm-7 col-xs-12 ">
                       ...
                       <input type="text" name="name" required class="form-control" placeholder="Enter Name"><br>
                        ...
                        <select class="form-control" name="sub_id">
                            ...
                            @foreach ($SubCategory as $comments)
                                <option value="{{ $comments->id }}">{{ $comments->name }}</option>
                            @endforeach
                        </select>
                       <br>
