    ...
    <div class="container-fluid" id="columns">
        ...
        <div class="center_column col-xs-12 col-sm-10" id="center_column">
            <div class="profile-board">
                ...
                <a href="{{ url('Owner/addBrand') }}" class="btn btn-success-outline" style="float: right">Add Brand</a>
                ...
                <tr>
                    ...
                    <?php $i = 1; ?>
                    @foreach ($film as $comments)
                <tr>
                    <td>{{$i}}</td>
                    <td>{{ $comments->name }}</td>
                    <td>{{ $comments->created_at }}</td>
                    <td>
                        <a href='{{ url("/Owner/deleteBr/{$comments->id}") }}' class="btn btn-danger" onclick="return confirm('Are you sure you want to delete it?')">Delete</a>
                    </td>
                </tr>
